...
final _entities = <ModelEntity>[
  ModelEntity(
      id: const IdUid(1, 5218829401675858284),
      name: 'LifeEvent',
      lastPropertyId: const IdUid(3, 3841605696394848236),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 369383566557538200),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 3531619794029721585),
            name: 'title',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(3, 3841605696394848236),
            name: 'count',
            type: 6,
            flags: 0)
      ],
...
ModelDefinition getObjectBoxModel() {
  final model = ModelInfo(
      entities: _entities,
      lastEntityId: const IdUid(1, 5218829401675858284),
